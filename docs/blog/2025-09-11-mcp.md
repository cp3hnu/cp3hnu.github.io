...
author: cp3hnu
location: ChangSha
summary: MCP (Model Context Protocol) 是一种开源标准，用于将 AI 应用程序与外部系统进行连接。
---
...
Claude Desktop 通过 **Connectors** 安装远程 MCP 服务
...
Claude Desktop 还允许安装任意的远程 MCP 服务，但是只对 Pro、Max、Team、 和 Enterprise 付费用户开放。更多详情请参考 [Getting Started with Custom Connectors Using Remote MCP](https://support.claude.com/en/articles/11175166-getting-started-with-custom-connectors-using-remote-mcp)。
